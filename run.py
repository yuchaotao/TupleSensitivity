...
def run(algo_name, arch, scale, q,  exclusion=[], report=False):
...
def run_TSens(arch, scale, q, exclusion=[], report=False):
    run('TSens', arch, scale, q, exclusion, report)

def run_Elastic(arch, scale, q, exclusion=[], report=False):
